...
GENRES = ['Jazz', 'Hip-Hop', 'Old-Time / Historic', 'Electronic',
          'Spoken', 'Experimental', 'Easy Listening', 'Classical',
          'Pop', 'Country', 'Rock', 'Soul-RnB', 'Blues',
          'Instrumental', 'Folk', 'International']

DIMENSIONALITY_REDUCTIONS_NAMES_LIST = ['ipca']
TRAIN_DATA_SIZE = 32238
TEST_DATA_SIZE = 17360
RANDOM_STATE = 42
CATEGORIES_AMOUNT = 16

##### LABEL NAMES
EXTERNAL_VARIABLES_NAMES = ['genre_top']
GENRE_TOP_NAME = 'genre_top'


##### METHODS

# given amount of rows, return folds where each fold is list of indices
# TODO: add remaining rows to last cv

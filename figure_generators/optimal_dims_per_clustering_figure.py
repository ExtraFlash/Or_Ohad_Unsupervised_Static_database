...
def plot_bar():
    ...
    plt.bar(left, height, color=utils.CLUSTERING_COLORS, width=barWidth, bottom=-1, tick_label=tick_label)
    ...
    plt.savefig(f'../figures/silhouette_optimal_per_cluster', pad_inches=0.2, bbox_inches="tight")
    plt.show()

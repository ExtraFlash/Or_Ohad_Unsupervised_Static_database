...
def plot_bar():
    ...
    # naming the y-axis
    plt.ylabel('Weighted Silhouette and MI')
    # plot title
    plt.title('Score between clustering methods and Genres')
    plt.savefig(f'../figures/mean_silhouette_MI_optimal_per_cluster', pad_inches=0.2, bbox_inches="tight")
    plt.show()
